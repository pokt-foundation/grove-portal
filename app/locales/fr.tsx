...
const schema = {
  ...
  AppPlanLatestInvoiceCard: {
    ...
    relaysUsed: "Total Relays of the current period -fr",
    dateStart: "Start -fr",
    dateEnd: "End -fr",
  ...
  security: {
    ...
    userAgentPlaceholder: "Type the user agent here -fr",
    userAgentAria: "Add user agents to the whitelist -fr",
    defaultSelectChainText: "Select Chain -fr",
    chainsDropdownAria: "Select a chain to add to the whitelist -fr",
    OriginPlaceholder: "Type the origin here -fr",
    OriginAria: "Add origins to the whitelist -fr",
    contractAria: "Add contract selections to the whitelist -fr",
    contractError:
      "You must select a chain and have a value to add to the methods whitelist. -fr",
    contractPlaceholder: "Type the contract here -fr",
    methodAria: "Add method selections to the whitelist -fr",
    methodError:
      "You must select a chain and have a value to add to the methods whitelist. -fr",
    methodPlaceholder: "Type the method here -fr",
    secretKeyText:
