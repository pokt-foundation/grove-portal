...
export type documentationimageArgs = {
  filter?: InputMaybe<directus_files_filter>
  limit?: InputMaybe<Scalars["Int"]>
  offset?: InputMaybe<Scalars["Int"]>
  page?: InputMaybe<Scalars["Int"]>
...
export type createContactSalesFormsItemMutation = {
  __typename?: "Mutation"
  create_contact_sales_forms_item?: {
    __typename?: "contact_sales_forms"
    id: string
  } | null
}
...
export type getDocsQuery = {
  ...
  documentation: Array<{
    ...
    status?: string | null
    weight?: number | null
    parent?: { __typename?: "documentation"; id: string; slug?: string | null } | null
    translations?: Array<{
      __typename?: "documentation_translations"
      id: string
      body?: string | null
...
export function getSdk(
  ...
  return {
    createContactSalesFormsItem(
      variables: createContactSalesFormsItemMutationVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<createContactSalesFormsItemMutation> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<createContactSalesFormsItemMutation>(
            createContactSalesFormsItemDocument,
            variables,
    ...
    getDocs(
      ...
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<getDocsQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<getDocsQuery>(getDocsDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getDocs",
    ...
    getGeneric(
      variables?: getGenericQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<getGenericQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<getGenericQuery>(getGenericDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getGeneric",
