...
export type getQuestionsQuery = { __typename?: 'Query', questions: Array<{ __typename?: 'questions', answer?: string | null, category?: string | null, id?: string | null, question?: string | null, status: string, tags?: Array<{ __typename?: 'questions_tags', id?: string | null } | null> | null }> };


export const getQuestionsDocument = gql`
    query getQuestions($filter: questions_filter, $limit: Int, $offset: Int, $page: Int, $search: String, $sort: [String]) {
  questions(
    filter: $filter
    limit: $limit
    offset: $offset
