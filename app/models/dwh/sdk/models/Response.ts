...
export function ResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): Response {
    ...
    return {
        ...
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(ResponseDataInnerFromJSON)),
    };
}
...
export function ResponseToJSON(value?: Response | null): any {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(ResponseDataInnerToJSON)),
    };
}
