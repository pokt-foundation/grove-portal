...
import { Logs, instanceOfLogs, LogsFromJSON, LogsFromJSONTyped, LogsToJSON } from "./Logs"
...
export function ResponseDataInnerFromJSONTyped(
  ...
  return {
    ...AnalyticsRelaysAggregatedFromJSONTyped(json, true),
    ...AnalyticsRelaysErrorsFromJSONTyped(json, true),
    ...AnalyticsRelaysTotalFromJSONTyped(json, true),
    ...AnalyticsRelaysTransactionsFromJSONTyped(json, true),
    ...LogsFromJSONTyped(json, true),
  }
}
