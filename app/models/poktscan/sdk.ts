...
export type GetHighestBlockQueryVariables = Exact<{ [key: string]: never; }>;


export type GetHighestBlockQuery = { __typename?: 'Query', highestBlock?: { __typename?: 'BlockItem', validatorThreshold?: number | null, item?: { __typename?: 'Block', height: number, time: string, producer: string, took: number, total_nodes: number, total_apps: number, total_accounts: number, total_txs: number, total_relays_completed?: number | null } | null } | null };


export const GetHighestBlockDocument = gql`
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getHighestBlock(variables?: GetHighestBlockQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<GetHighestBlockQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetHighestBlockQuery>(GetHighestBlockDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getHighestBlock', 'query');
    }
  };
}
