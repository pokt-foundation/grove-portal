...
export type GetHighestBlockQuery = {
  __typename?: "Query"
  highestBlock?: {
    __typename?: "BlockItem"
...
export function getSdk(
  ...
  return {
    getHighestBlock(
      variables?: GetHighestBlockQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"],
    ): Promise<GetHighestBlockQuery> {
      return withWrapper(
        (wrappedRequestHeaders) =>
          client.request<GetHighestBlockQuery>(GetHighestBlockDocument, variables, {
            ...requestHeaders,
            ...wrappedRequestHeaders,
          }),
        "getHighestBlock",
