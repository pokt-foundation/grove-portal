...
describe("<AppKeysCard />", () => {
  it("renders application id", () => {
    render(<KeysCard id={id} isMember={false} />)
  ...
  it("renders secret key", () => {
    render(<KeysCard id={id} isMember={false} secret={secret} />)
  ...
  it("renders public key", () => {
    render(<KeysCard id={id} isMember={false} publicKey={publicKey} />)
  ...
  it("displays inputs properly", () => {
    render(<KeysCard id={id} isMember={false} publicKey={publicKey} secret={secret} />)
