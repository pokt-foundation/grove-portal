...
export const CHAIN_ID_PREFIXES = new Map<string, ChainMetadata>([
  ["0001", { prefix: "mainnet", name: "Pocket Mainnet", abbrv: "Mainnet", evm: false }],
  [
    "0003",
    {
      prefix: "avax-mainnet",
  ...
  ["0005", { prefix: "fuse-mainnet", name: "Fuse Mainnet", abbrv: "Fuse", evm: true }],
  [
    "0006",
    {
  ...
  ["0026", { prefix: "eth-goerli", name: "Ethereum Goerli", abbrv: "ETH", evm: true }],
  [
    "0027",
    {
      prefix: "poa-xdai",
  ...
  ["0047", { prefix: "oec-mainnet", name: "OEC Mainnet", abbrv: "OEC", evm: true }],
  ["0048", { prefix: "boba-mainnet", name: "BOBA Mainnet", abbrv: "BOBA", evm: true }],
  [
    "0049",
    {
  ...
  ["0004", { prefix: "bsc-mainnet", name: "BSC Mainnet", abbrv: "BSC", evm: true }],
  ["0052", { prefix: "near-mainnet", name: "NEAR Mainnet", abbrv: "NEAR", evm: true }],
])
...
export function getServiceLevelByChain(chainId: string): "Production" | "Alpha" | "Beta" {
